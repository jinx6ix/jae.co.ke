...
const schemaData = {
  ...
  "@graph": [
    { "@type": "WebPage", url: ABSOLUTE_URL, name: "Group Joining Safaris Kenya 2026", description: "Join group safaris in Kenya 2026. Shared 4x4 Land Cruisers, all-inclusive, from $610. Meet fellow travelers.", primaryImageOfPage: { "@type": "ImageObject", url: HERO_IMG, width: 1200, height: 630 } },
    { "@type": "TouristAttraction", name: "Kenya Wildlife Safari Destinations", description: "Kenya offers world-class safari experiences across iconic parks including Masai Mara, Amboseli, Lake Nakuru, and more. Group safaris provide the perfect balance of adventure, social connection, and value.", image: HERO_IMG, address: { "@type": "PostalAddress", addressLocality: "Nairobi", addressRegion: "Kenya", addressCountry: "KE" }, geo: { "@type": "GeoCoordinates", latitude: -1.286389, longitude: 36.817223 } },
