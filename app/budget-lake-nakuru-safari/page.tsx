...
const schemaData = {
  ...
  "@graph": [
    { "@type": "WebPage", "@id": `${ABSOLUTE_URL}#webpage`, url: ABSOLUTE_URL, name: "Budget Lake Nakuru Safari Kenya 2026", description: "Lake Nakuru safari tours from $610. Flamingos, black/white rhinos, Big Five. Book your 2026 trip.", isPartOf: { "@type": "WebSite", "@id": `${BASE_URL}/#website`, name: "JaeTravel Expeditions", url: BASE_URL }, primaryImageOfPage: { "@type": "ImageObject", url: HERO_IMG, width: 1200, height: 630 } },
    { "@type": "TouristAttraction", "@id": `${BASE_URL}/destinations/lake-nakuru#attraction`, name: "Lake Nakuru National Park", description: "Lake Nakuru National Park is a UNESCO Ramsar site famous for its millions of flamingos creating pink shorelines, successful rhino conservation, and Rothschild giraffe sanctuary.", image: HERO_IMG, address: { "@type": "PostalAddress", addressLocality: "Lake Nakuru", addressRegion: "Kenya", addressCountry: "KE" }, geo: { "@type": "GeoCoordinates", latitude: -0.3637, longitude: 36.082 }, aggregateRating: { "@type": "AggregateRating", ratingValue: "4.8", reviewCount: "923" } },
    ...
    { "@type": "FAQPage", mainEntity: [
      ...
      { "@type": "Question", name: "Are there lions and leopards in Lake Nakuru?", acceptedAnswer: { "@type": "Answer", text: "Yes. While Lake Nakuru is famous for rhinos and birds, it also has healthy lion and leopard populations. Lions are regularly spotted near the rhino sanctuary boundaries, and leopards inhabit the rocky outcrops and riverine forests. The park's varied terrain supports diverse predators." } },
