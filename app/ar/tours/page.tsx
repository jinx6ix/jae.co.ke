...
const toursPageSchema = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.jaetravel.co.ke/ar/tours/#webpage",
      url: "https://www.jaetravel.co.ke/ar/tours",
      ...
      breadcrumb: { "@id": "https://www.jaetravel.co.ke/ar/tours/#breadcrumb" },
      inLanguage: "ar",
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.jaetravel.co.ke/ar/tours/#breadcrumb",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "الرئيسية", item: "https://www.jaetravel.co.ke/ar" },
        { "@type": "ListItem", position: 2, name: "الجولات", item: "https://www.jaetravel.co.ke/ar/tours" },
      ],
    },
    {
      "@type": "FAQPage",
    ...
    ...tours.map((tour) => ({
      "@type": "Product",
      "@id": `https://www.jaetravel.co.ke/ar/tours/${tour.id}`,
      name: tour.title,
