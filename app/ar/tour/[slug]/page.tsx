...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}/ar/tour/${tour.slug}`,
      languages: {
        ar: `${baseUrl}/ar/tour/${tour.slug}`,
        en: `${baseUrl}/tours/${tour.slug}`,
        "x-default": `${baseUrl}/tour/${tour.slug}`,
      },
    },
    openGraph: {
      title,
        ...
        <section className="border-b border-border bg-muted/30 py-4">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <Link href="/ar/tour" className="hover:text-foreground">
                الجولات
              </Link>
              <ChevronRight className="h-4 w-4" />
