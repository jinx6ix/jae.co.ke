// app/zh/vehicle-hire/[slug]/page.tsx
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${vehicle.metaTitle} | 捷旅探险`,
    description: vehicle.metaDescription,
    keywords: vehicle.keywords,
    alternates: { canonical: `${BASE_URL}/zh/vehicle-hire/${slug}`, languages: buildHreflangAlternates(`/vehicle-hire/${slug}`) },
    openGraph: { title: vehicle.metaTitle, description: vehicle.metaDescription, url: `${BASE_URL}/zh/vehicle-hire/${slug}`, locale: "zh_CN", type: "website", images: [{ url: imageUrl, width: 1200, height: 630, alt: vehicle.name }] },
  }
}
...
export default async function VehicleHirePage({ params }: Props) {
  ...
  const schema = {
    ...
    url:`${BASE_URL}/zh/vehicle-hire/${slug}`,
    ...
    <>
      ...
      <nav className="bg-gray-50 py-3 px-4 text-sm" dir="ltr">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-gray-500">
          ...
          <Link href="/zh/vehicle-hire" className="hover:text-orange-500">租车服务</Link><span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-10">
            ...
            {vehicle.features?.length>0&&(
              <div><h2 className="text-2xl font-serif font-bold mb-4">特点</h2>
            ...
            <div><h2 className="text-2xl font-serif font-bold mb-4">规格</h2>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-2xl shadow-xl border p-6">
              ...
              <a href={`https://wa.me/254726485228?text=您好%2C%20我想租这辆车%3A%20${encodeURIComponent(vehicle.name)}`} target="_blank" rel="noopener noreferrer" className="block w-full bg-orange-500 hover:bg-orange-600 text-white text-center font-bold py-4 rounded-xl mb-3">💬 通过WhatsApp预订</a>
