// app/it/vehicle-hire/[slug]/page.tsx
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${vehicle.metaTitle} | JaeTravel Spedizioni`,
    description: vehicle.metaDescription,
    keywords: vehicle.keywords,
    alternates: { canonical: `${BASE_URL}/it/vehicle-hire/${slug}`, languages: buildHreflangAlternates(`/vehicle-hire/${slug}`) },
    openGraph: { title: vehicle.metaTitle, description: vehicle.metaDescription, url: `${BASE_URL}/it/vehicle-hire/${slug}`, locale: "it_IT", type: "website", images: [{ url: imageUrl, width: 1200, height: 630, alt: vehicle.name }] },
  }
}
...
export default async function VehicleHirePage({ params }: Props) {
  ...
  const schema = {
    ...
    url:`${BASE_URL}/it/vehicle-hire/${slug}`,
    ...
    <>
      ...
      <nav className="bg-gray-50 py-3 px-4 text-sm" dir="ltr">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-gray-500">
          ...
          <Link href="/it/vehicle-hire" className="hover:text-orange-500">Noleggio Veicoli</Link><span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-10">
            ...
            {vehicle.features?.length>0&&(
              <div><h2 className="text-2xl font-serif font-bold mb-4">Caratteristiche</h2>
            ...
            <div><h2 className="text-2xl font-serif font-bold mb-4">Specifiche</h2>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-2xl shadow-xl border p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-500 text-sm">al giorno</p>
              </div>
              ...
              <a href={`https://wa.me/254726485228?text=Ciao%2C%20voglio%20noleggiare%20il%20veicolo%3A%20${encodeURIComponent(vehicle.name)}`} target="_blank" rel="noopener noreferrer" className="block w-full bg-orange-500 hover:bg-orange-600 text-white text-center font-bold py-4 rounded-xl mb-3">💬 Prenota via WhatsApp</a>
