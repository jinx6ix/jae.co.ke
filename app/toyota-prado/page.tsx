  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="prose mx-auto max-w-3xl mb-12">
        <h2 className="font-serif text-3xl font-bold mb-6 text-center">Why Choose Toyota Prado</h2>
      ...
      <div className="rounded-2xl bg-muted/50 p-8 mb-12 text-center">
        ...
        <blockquote className="italic text-muted-foreground max-w-xl mx-auto">
          “The Toyota Prado was perfect for our self-drive safari—reliable, comfortable, and ready for any terrain!”
        </blockquote>
        <p className="mt-2 text-sm font-semibold">— James K., Road Trip Explorer</p>
      </div>
      ...
      <div className="mt-12 rounded-2xl bg-primary/10 p-8 text-center animate-in zoom-in duration-500">
        ...
        <p className="mx-auto mb-6 max-w-xl text-muted-foreground leading-relaxed">
          Don’t just dream of adventure—live it! Rent your Toyota Prado for the ultimate self-drive safari.
        </p>
        <Button
          asChild
          size="lg"
