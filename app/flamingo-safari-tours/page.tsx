...
const MigrationCalendar = dynamic(() => import("@/components/MigrationCalendar"), {
  ssr: false,
  loading: () => <div className="h-96 bg-gray-100 rounded-xl animate-pulse" />
})

const LiveWildlifeReport = dynamic(() => import("@/components/LiveWildlifeReport"), {
  ssr: false,
    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        <div className="container mx-auto px-6 md:px-8 lg:px-12 py-8 md:py-16 max-w-7xl">
          ...
          {/* Live Wildlife Report - Client Component */}
