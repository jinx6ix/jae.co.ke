// app/flamingo-safari-tours/page.tsx
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description: "Witness thousands of flamingos and rhinos at Kenya's most famous soda lake.",
      itinerary: [
        {
        ...
        <div className="container mx-auto px-6 md:px-8 lg:px-12 py-8 md:py-16 max-w-7xl">
          ...
          <section className="mb-40">
            ...
            <div className="aspect-video w-full max-w-5xl mx-auto rounded-2xl overflow-hidden shadow-2xl">
              <iframe 
                width="100%" 
                height="100%" 
                src="https://www.youtube.com/embed/your-flamingo-video-id" 
                title="Flamingo Safari - Lake Nakuru Kenya"
                frameBorder="0" 
          ...
          <section className="mb-40">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-6 shadow-md">
          ...
          <section className="mb-20">
            <div className="bg-gradient-to-r from-pink-600 via-purple-600 to-blue-600 rounded-3xl p-16 md:p-20 text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  asChild 
                  className="bg-white text-pink-700 hover:bg-gray-100 px-10 py-6 rounded-full min-w-[200px]"
                >
                  <Link href="/booking">
