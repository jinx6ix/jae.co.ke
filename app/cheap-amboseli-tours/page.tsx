...
const schemaData = {
  ...
  "@graph": [
    { "@type": "WebPage", url: ABSOLUTE_URL, name: "Cheap Amboseli Tours Kenya 2026", description: "Book affordable Amboseli budget tours 2026 from $750. Watch elephants with Mt. Kilimanjaro backdrop, spot Big Five, enjoy flamingos at Lake Amboseli.", primaryImageOfPage: { "@type": "ImageObject", url: HERO_IMG, width: 1200, height: 630 } },
    { "@type": "TouristAttraction", name: "Amboseli National Park", description: "Amboseli National Park is Kenya's second-most popular park, famous for large elephant herds with Kilimanjaro backdrop, predator sightings, and 400+ bird species.", image: HERO_IMG, address: { "@type": "PostalAddress", addressLocality: "Amboseli", addressRegion: "Kenya", addressCountry: "KE" }, geo: { "@type": "GeoCoordinates", latitude: -2.2864, longitude: 37.2236 } },
