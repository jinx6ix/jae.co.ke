...
export const metadata: Metadata = {
  title: "من نحن — جيه تريفل للرحلات الاستكشافية | JaeTravel",
  description: "تأسست في نيروبي، جيه تريفل للرحلات الاستكشافية متخصصة في سفاري شرق أفريقيا. نحن رواد سفاري ذوي الإعاقة.",
  alternates: { canonical: `${BASE_URL}/ar/about`, languages: buildHreflangAlternates("/about") },
  openGraph: { title: "من نحن — جيه تريفل للرحلات الاستكشافية", url: `${BASE_URL}/ar/about`, locale: "ar_AE", type: "website", images: [{ url: `${BASE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "JaeTravel" }] },
}

export default function AboutPage() {
  const values = ['التميز في الخدمة', 'السياحة المسؤولة', 'الإمكانية الشاملة', 'الخبرة المحلية', 'رضا العملاء 100%']
  return (
    <CmsPage slug="about" locale="ar" fallback={
    <div className="max-w-7xl mx-auto px-4 py-16" dir="rtl">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6">من نحن — جيه تريفل للرحلات الاستكشافية</h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">تأسست في نيروبي، جيه تريفل للرحلات الاستكشافية متخصصة في سفاري شرق أفريقيا. نحن رواد سفاري ذوي الإعاقة.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
        ...
        <div>
          <h2 className="text-3xl font-serif font-bold mb-4">مهمتنا</h2>
          <p className="text-gray-700 leading-relaxed mb-6">جعل تجارب سفاري أفريقيا في متناول الجميع بغض النظر عن مستوى الحركة.</p>
      ...
      <div>
        <h2 className="text-3xl font-serif font-bold text-center mb-8">قيمنا</h2>
