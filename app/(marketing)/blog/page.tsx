...
function buildBlogPageSchema(posts: { slug: string; title: string; image: string; publishedAt: string; author: string; excerpt: string; keywords: string[] }[]) {
  return {
    ...
    "@graph": [
      ...
      // 5. Blog (main entity with BlogPosting items)
      {
        "@type": "Blog",
        "@id": "https://www.jaetravel.co.ke/blog/#blog",
        "url": "https://www.jaetravel.co.ke/blog",
        ...
        "blogPost": posts.slice(0, 10).map(post => ({
          ...
          "image": {
            "@type": "ImageObject",
            "url": post.image?.startsWith('http') ? post.image : (post.image ? `https://www.jaetravel.co.ke${post.image}` : "https://www.jaetravel.co.ke/blog/blog-hero.jpg"),
            "width": 1200,
            "height": 630
          },
          ...
          "keywords": post.keywords?.join(", ") || "safari, East Africa, wildlife, travel tips, accessible travel"
        }))
      },
...
export default async function BlogPage() {
  ...
  const blogPageSchema = buildBlogPageSchema(blogPosts)
