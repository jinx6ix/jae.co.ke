...
import { getAllBlogSlugs, getBlogPostBySlug, getAllBlogPosts, type BlogPost } from "@/lib/posts"
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: post.image && post.image.startsWith("http")
            ? post.image
            : post.image
              ? `${baseUrl}${post.image}`
              : `${baseUrl}/blog/blog-hero.jpg`,
          width: 1200,
          height: 630,
          alt: post.title,
          type: "image/jpeg",
...
function getAbsoluteUrl(path: string | undefined | null): string {
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || "https://www.jaetravel.co.ke"
  if (!path) return `${baseUrl}/blog/blog-hero.jpg`
      ...
      <div className="pb-16">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="mx-auto max-w-4xl">
            ...
            {/* Related Tours (drives internal links to booking pages) */}
