  ...
  return (
    <section className="relative aspect-[16/9] overflow-hidden rounded-2xl mb-16">
      <Image
        ...
        alt="Toyota Prado 4x4 en safari dans le Maasai Mara avec toit pop-up ouvert à l’heure dorée"
        fill
        priority
        sizes="100vw"
