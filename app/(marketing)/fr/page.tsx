...
// Wraps the static landing page in <CmsPage locale="fr"> so editors
// can override the body in /admin. The static body below remains
// the fallback when no Pages doc exists for this slug/locale yet.
