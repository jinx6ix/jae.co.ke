...
export async function GET() {
  ...
  // Pull blog slugs from CMS (preferred) and merge with the static
  // `lib/blog-data.ts` array. The CMS list is the source of truth for
  // the 75 SEO-targeted posts; the static array still backs any
  // legacy blog slugs not yet migrated to the CMS.
