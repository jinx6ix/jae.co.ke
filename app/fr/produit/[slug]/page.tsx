  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="prose mx-auto max-w-3xl mb-12">
        <h2 className="font-serif text-3xl font-bold mb-6 text-center">Ce Que Vous Vivrez</h2>
      ...
      {/* Details Section */}
      <div className="prose mx-auto max-w-3xl mb-12">
        <h2 className="font-serif text-3xl font-bold mb-4">Votre Aventure Vous Attend</h2>
      ...
      <div className="rounded-2xl bg-muted/50 p-8 mb-12 text-center">
        ...
        <blockquote className="italic text-muted-foreground max-w-xl mx-auto">
          “Ce fut le voyage d’une vie ! Les paysages, la faune et les guides ont donné vie à la magie de l’Afrique de l’Est.”
        </blockquote>
        <p className="mt-2 text-sm font-semibold">— Sarah M., Chercheuse d’Aventures</p>
      </div>

      {/* CTA Section */}
      <div className="mt-12 rounded-2xl bg-primary/10 p-8 text-center animate-in zoom-in duration-500">
        <h2 className="mb-4 font-serif text-3xl font-bold text-primary">Prêt pour le Voyage ?</h2>
        <p className="mx-auto mb-6 max-w-xl text-muted-foreground leading-relaxed">
          Ne rêvez pas seulement d’aventure—vivez-la ! Laissez nos experts créer votre expérience {product.name} parfaite.
        </p>
        <Button
          asChild
          size="lg"
...
export async function generateStaticParams() {
  return products
    .filter((product) => product.slug === "safari-twiga")
    .map((product) => ({
      slug: product.slug,
    }));
}