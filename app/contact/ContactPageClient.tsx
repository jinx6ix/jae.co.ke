      ...
      <div className="grid gap-8 lg:grid-cols-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={6}
                    className="mt-2 border-orange-300 focus:border-orange-500"
                    placeholder="Tell us about your dream safari, group size, travel dates, or any special requirements..."
                  />
                </div>
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Saturday: 9:00 AM – 2:00 PM EAT</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-[#25D366]/10 border-green-200">
            <CardContent className="p-6">
              <h3 className="mb-3 font-semibold">Quick Chat on WhatsApp</h3>
              <p className="mb-4 text-sm text-muted-foreground">
                Get instant answers from our safari specialists.
              </p>
