...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: `${BASE}/Safaris2.jpg`, width: 1200, height: 630, alt: "Serengeti National Park" }],
    locale: "en_KE",
  },
  twitter: {
...
const destinationData = {
  ...
  country: "Tanzania",
  tagline: "Endless Plains - Where the Great Migration Roams",
  heroImage: "/Safaris2.jpg",
  description: "The Serengeti is Tanzania's crown jewel, famous for its endless savannah plains and the annual Great Migration where millions of wildebeest, zebras, and gazelles traverse the landscape in search of fresh grazing. It's one of Africa's most iconic safari destinations.",
  highlights: ["Great Migration (July-October)", "Big Five wildlife", "Hot air balloon safaris", "Endless plains", "World-class game viewing", "Sunset game drives"],
  wildlife: ["Lions", "Leopards", "Cheetahs", "Elephants", "Buffalo", "Rhino", "Wildebeest", "Zebra", "Hippo", "Crocodile"],
  bestTime: "Year-round, migration June-October",
  activities: ["Game Drives", "Balloon Safari", "Photography", "Bush Dinners", "Nature Walks"],
  parkFees: "Adults: $60/day, Children: $20/day",
};

export default function SerengetiPage() {
  const relatedTours = tours.filter(t => t.title.toLowerCase().includes("serengeti") || t.description?.toLowerCase().includes("serengeti")).slice(0, 3);
  const schema = { "@context": "https://schema.org", "@type": "TouristAttraction", name: destinationData.name, description: destinationData.description, image: `${BASE}${destinationData.heroImage}`, aggregateRating: { "@type": "AggregateRating", ratingValue: "4.9", reviewCount: "512" } };
  ...
  return (
    <>
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="text-lg"><Link href="/tours">View Serengeti Tours</Link></Button>
      ...
      <section className="py-16 bg-background"><div className="container mx-auto px-4"><div className="grid md:grid-cols-2 gap-12 items-center">
        <div><h2 className="text-4xl font-bold mb-6 font-serif">About {destinationData.name}</h2><p className="text-lg text-muted-foreground leading-relaxed mb-6">{destinationData.description}</p><p className="text-lg text-muted-foreground leading-relaxed">Covering over 14,750 square kilometers, the Serengeti offers unparalleled wildlife experiences. The park is home to the largest concentration of large mammals on the planet, with predator-prey interactions happening daily.</p></div>
