  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // forget — the customer email already went out, the user-visible
        // success path is the email. A failed DB write is logged but does
        // not block the UI. The dashboard can backfill from the email.
