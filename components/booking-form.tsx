...
export default function BookingForm({ tourTitle, tourPrice, tourDuration, serviceType = "tour", tourSlug }: BookingFormProps) {
  ...
  // Failure panel — the customer email has been sent, but the dashboard
  // never saw the row. Tell the user honestly and keep the WhatsApp
  // / contact channels open so they can confirm out-of-band.
  ...
  // Loading panel — the email route is done, we're waiting on the DB write.
