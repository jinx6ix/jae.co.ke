...
export interface Page {
  ...
  title: string;
  /**
   * Language of this page. English is the default.
   */
  locale?: ('en' | 'fr' | 'de' | 'it' | 'hi' | 'ar' | 'zh') | null;
  hero: {
...
export interface Post {
  ...
  /**
   * Polymorphic — link tours and/or budget-tours to drive internal cross-links from this post to the booking pages.
   */
  relatedTours?:
    | (
        | {
...
export interface Tour {
   ...
   */
  jaedbTourPackageId?: string | null;
  /**
   * Used on tour cards/listing pages.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "budget-tours".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TourGridBlock".
 */
export interface TourGridBlock {
  heading?: string | null;
  intro?: string | null;
  /**
   * How many tour cards to show. Leave blank for all tours.
   */
  limit?: number | null;
  /**
  ...
  /**
   * Label of the "see more" link shown when more tours exist than the limit.
   */
...
export interface BlogArchiveBlock {
  ...
  limit?: number | null;
  /**
   * Optional category slug to filter posts. Leave blank to show all posts.
   */
  category?: string | null;
  id?: string | null;
  blockName?: string | null;
...
export interface StatisticsBlock {
  ...
  items?:
    | {
        /**
         * The big number / figure (e.g. "17+", "1,200", "98%").
         */
        value: string;
        /**
         * Short caption under the value (e.g. "Years guiding").
         */
        label: string;
        /**
         * Optional lucide icon name (e.g. "Award", "Heart").
         */
        icon?: string | null;
        id?: string | null;
      }[]
...
export interface TestimonialsBlock {
  ...
  items?:
    | {
        ...
        name: string;
        /**
         * Optional — e.g. "Solo traveller, UK" or "Wheelchair user, USA".
         */
        role?: string | null;
        rating?: number | null;
...
export interface Hotel {
  ...
  jaedbHotelId: number;
  /**
   * e.g. Maasai Mara, Amboseli — should match the county name in jaedb for the pairing to be obvious.
   */
  region?: string | null;
  description?: {
    root: {
...
export interface Vehicle {
  ...
  title: string;
  /**
   * The cuid of the matching Vehicle record in jaedb, if this vehicle is bookable there.
   */
  jaedbVehicleId?: string | null;
  vehicleType?: ('SUV' | 'Van' | 'Luxury' | 'Overland' | 'Accessible' | 'Photography' | 'Minivan') | null;
  description?: {
    root: {
      type: string;
      children: {
...
/**
 * Country-level destination pages (e.g. Kenya, Tanzania).
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Destination {
  ...
  title: string;
  /**
   * Country name. Usually same as title.
   */
  country?: string | null;
  /**
   * One-paragraph wildlife-focused highlight.
   */
  ...
  description?: string | null;
  /**
   * Full destination story on the country page.
   */
  longDescription?: {
    root: {
      type: string;
  ...
  /**
   * Traveller types this destination is best for.
   */
  bestFor?:
    | {
        text?: string | null;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        tourGrid?: T | TourGridBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TourGridBlock_select".
 */
export interface TourGridBlockSelect<T extends boolean = true> {
  heading?: T;
  intro?: T;
  limit?: T;
  category?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "budget-tours_select".
 */
export interface BudgetToursSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  shortDescription?: T;
  longDescription?: T;
